...
public class LockingRateLimitingRequestThrottler implements RequestThrottler {

  private static final Logger LOG =
      LoggerFactory.getLogger(LockingRateLimitingRequestThrottler.class);
  ...
  public LockingRateLimitingRequestThrottler(DriverContext context) {
    this(context, System::nanoTime);
  }

  private LockingRateLimitingRequestThrottler(DriverContext context, NanoClock clock) {
